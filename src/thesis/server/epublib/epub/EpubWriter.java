...
public class EpubWriter {
	...
	public void write(Book book, OutputStream out) throws IOException, XMLStreamException, FactoryConfigurationError, Exception {
		...
		writeResources(book, resultStream); //done
		writePackageDocument(book, resultStream); //TODO find a way to encrypt this
		encrypter.writeDecryptLib(resultStream);
		resultStream.close();
	}
	...
	private void writeResources(Book book, ZipOutputStream resultStream) throws Exception {
		for(Resource resource: book.getResources().getAll()) {
			if(encrypter != null)
				encrypter.encrypt(resource);
